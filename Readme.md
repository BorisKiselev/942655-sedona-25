...
* Студент: [Борис Киселев](https://up.htmlacademy.ru/htmlcss/25/user/942655).
* Наставник: `Повторно, без наставника`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/942655-sedona-25) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
